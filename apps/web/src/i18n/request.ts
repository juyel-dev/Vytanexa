...
const NAMESPACES = ['common', 'nav', 'onboarding', 'home', 'doctor', 'settings', 'offline', 'articles', 'hospital', 'shared', 'reviews', 'location', 'emergency', 'blood', 'qa', 'account', 'seo', 'validation', 'more', 'polls', 'search', 'auth', 'symptoms', 'labTests'] as const;
